...
<?php echo "<?php echo CHtml::link('Advanced Search','#',array('class'=>'search-button btn center_btn')); ?>"; ?>
...
<?php echo "<?php"; ?> $this->widget('ext.yiisortablemodel.widgets.SortableCGridView',array(
